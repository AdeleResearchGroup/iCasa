 ...
 *
 */
@ContextEntity(coreServices = {BinaryLight.class,SimulatedDevice.class})
...
public class DemoBinaryLightImpl implements BinaryLight, SimulatedDevice,GenericDevice{
