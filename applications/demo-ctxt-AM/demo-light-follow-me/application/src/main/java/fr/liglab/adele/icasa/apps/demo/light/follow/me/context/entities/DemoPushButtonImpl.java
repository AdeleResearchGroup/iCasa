 ...
 */
package fr.liglab.adele.icasa.apps.demo.light.follow.me.context.entities;
...
public class DemoPushButtonImpl implements PushButton,SimulatedDevice,GenericDevice{

    public final static String SIMULATED_PUSH_BUTTON = "iCasa.PushButton";

    @State.Field(service = PushButton.class,state = PUSH_AND_HOLD,value = "false")
